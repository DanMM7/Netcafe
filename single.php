				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-5">
							<div class="gal-wrap">
								<div id="gal-slider" class="flexslider">
									<ul class="slides">
										<li><img src="./Admin/Manager/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/></li>
									</ul>
								</div>
								<ul class="gal-nav">
									<li>
										<div>
											<img src="./Admin/Manager/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/>
										</div>
									</li>
								</ul>
						...
						<div class="col-md-7 product-single">
							...
							<br>
							<div class="p-price">R <?php echo $prodr['price']; ?>.00</div>
							<br>
							...
							<div style="" class="tab-pane fade" id="mini-three">
								...
								<?php
								 ...
								 ?>
									...
									<?php 
										$selrevsql = "SELECT u.firstname, u.lastname, r.`timestamp`, r.review FROM reviews r JOIN customers u WHERE r.uid=u.uid AND r.pid=$id";
									...
									<?php
										$usersql = "SELECT u.email, u1.firstname, u1.lastname FROM users u JOIN customers u1 WHERE u.id=u1.uid AND u.id=$uid";
								...
								<div class="sm-item isotope-item">
									<div class="product">
										<div class="product-thumb">
											<img src="./Admin/Manager/<?php echo $relr['thumb']; ?>" class="img-responsive" alt="">
										...
										<div class="product-price">R <?php echo $relr['price']; ?>.00<span></span></div>
									</div>
								</div>
							<?php } ?>
							</div>
